...
import gensim
from joblib import Parallel, delayed    #NEED TO INSTALL!!!
...
def trainAndValid(i, vectorSize):
    #print('Fold', i, '....')
    ...
    X_valid = generateX(df_valid, vectorSize)
...
if __name__ == '__main__':
    ...
    ### Cross validation
    accs = Parallel(n_jobs=multiprocessing.cpu_count())(delayed(trainAndValid)(i, vectorSize) for i in range(5))
